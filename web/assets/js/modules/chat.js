(function() {
    ...
    class ChatManager {
                    ...
                    return `
                        <div class="search-result" data-index="${index}">
                            ...
                            <div class="result-actions">
                                <button onclick="app.chatManager.viewFullContent(${index})">查看详情</button>
                            </div>
                        </div>
                    `;
                }).join('');
        ...
        viewFullContent(index) {
            ...
            if (resultElement) {
                const content = resultElement.querySelector('.result-content p').textContent;
                const detailModal = document.getElementById('resultDetail');
                const detailContent = document.getElementById('detailContent');
                
                detailContent.innerHTML = this.escapeHtml(content);
